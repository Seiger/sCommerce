<?php return [
    ...
    "deliveries" => "Доставки",
    "deliveries_help" => "Список доступных доставок магазина и их настройка.",
    "deliveries_icon" => "fa fa-shipping-fast",
    "deliveries_on_help" => "Включить функционал доставки на сайте.",
    "delivery" => "Доставка",
    ...
    "payments" => "Платежи",
    "payments_help" => "Список доступных оплат магазина и их настройка.",
    ...
    "type_custom" => "Индивидуальный",
    "type_downloadable" => "Загружаемый",
    "type_group" => "Сгруппированный",
    "type_input" => "Тип ввода",
    "type_optional" => "Опциональный",
    "type_preorder" => "Предзаказ",
    "type_service" => "Услуга",
    "type_simple" => "Типовой",
    "type_subscription" => "Подписка",
    "type_variable" => "Вариативный",
    "type_virtual" => "Виртуальный",
