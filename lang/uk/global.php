<?php return [
    "repeat_draft" => "Копія замовлення № :number. Перевір товари й ціни оригіналу та збережи для створення нового замовлення. Оплати, ТТН та попередню історію не перенесено.",
    "repeat_invalid" => "Перевір товари, кількість, ціни та контактні дані.",
    "repeat_error" => "Не вдалося підтвердити збереження копії. Повтори збереження в цій самій формі.",
    "order_history_deleted" => "Замовлення видалено",
    "print_order_heading" => "Замовлення клієнта № :number від :date",
    "print_seller" => "Виконавець",
    "print_customer" => "Замовник",
    "print_positions" => "Всього найменувань: :count",
    "print_manager" => "Менеджер",
    "print_delivery_arrangement" => "За домовленістю",
    "bulk_paid" => "Позначити як оплачені",
    "bulk_print" => "Друк замовлень",
    "bulk_delete" => "Видалити вибрані",
    "bulk_paid_confirm" => "Підтверджуєш отримання неоплаченого залишку за вибраними замовленнями (:count)? Уже оплачені буде пропущено.",
    "bulk_delete_confirm" => "М’яко видалити вибрані замовлення (:count)? Їх можна буде відновити.",
    "bulk_paid_ineligible" => "У виборі є онлайн-оплата, спірна/повернена оплата або невідомий залишок. Перевір ці замовлення окремо. Нічого не змінено.",
    "bulk_menu_forbidden" => "Недостатньо прав для масових дій із замовленнями.",
    "bulk_menu_invalid" => "Вибери від 1 до :limit різних замовлень і коректну дію.",
    "bulk_menu_missing" => "Одне з вибраних замовлень уже недоступне. Онови список. Нічого не змінено.",
    "bulk_menu_error" => "Не вдалося виконати дію. Зміни не збережено.",
    "bulk_menu_success" => "Оброблено: :updated. Без змін: :unchanged.",
    "bulk_menu_warning" => "Зміни збережено, але додатковий обробник завершився помилкою.",
    "bulk_menu_pending" => "Обробка вибраних замовлень…",
    "bulk_print_blocked" => "Дозволь спливні вікна для відкриття документа друку.",
    "export_tracking" => "ТТН",
    "bulk_export_pending" => "Формування CSV…",
    "bulk_export_success" => "Завантаження CSV розпочато.",
    "bulk_export_forbidden" => "Недостатньо прав для експорту замовлень.",
    "bulk_export_invalid" => "Вибери від 1 до :limit різних замовлень.",
    "bulk_export_missing" => "Одне з вибраних замовлень більше недоступне. Онови список перед експортом.",
    "bulk_export_error" => "Не вдалося завантажити CSV. Спробуй ще раз.",
    "add" => "Додати",
    ...
    "orders_settings" => "Налаштування замовлень",
    "checkout_settings" => "Кошик та замовлення",
    "checkout_settings_intro" => "Ці налаштування визначають відображення товарних атрибутів у кошику та правила формування номерів замовлень sCommerce.",
    "orders_reference_prefix" => "Префікс номера",
    "orders_reference_prefix_help" => "Префікс, який буде додано перед порядковим номером (наприклад: #, ORD_).",
    "orders_reference_start" => "Початковий номер",
    "orders_reference_start_help" => "Початкове значення лічильника для формування номера замовлення.",
    "orders_reference_pad_left" => "Доповнення нулями зліва",
    "orders_reference_pad_left_help" => "Мінімальна довжина номера з доповненням нулями зліва (0 = без доповнення).",
    "confirm_copy" => "Підтвердити копіювання",
    "confirm_duplicate" => "Підтвердити дублювання",
    ...
    "products_settings" => "Товари",
    "products_settings_intro" => "Ці налаштування визначають функціональність картки товару та набір полів, які відображаються у списку товарів sCommerce.",
    ...
    "notifications_email_intro" => "Ці налаштування визначають адреси отримувачів і шаблони email-сповіщень sCommerce для адміністратора та замовника.",
    "notifications_email_administrator" => "Адміністратор",
    "notifications_email_customer" => "Замовник",
    ...
    "notifications_email_addresses_default" => "Адреси для сповіщень типово",
    "notifications_email_addresses_default_help" => "Базовий список Емейл адрес для системних сповіщень sCommerce. Використовується як fallback, якщо для поточного домену не задано окремі адреси.",
    "notifications_email_addresses_site_help" => "Список Емейл адрес для системних сповіщень цього домену. Якщо поле порожнє, буде використано типовий список.",
    ...
    "bulk_status_confirm" => "Змінити статус вибраних замовлень (:count) на «:status»?",
    "bulk_status_pending" => "Змінюємо статус…",
    "bulk_status_post_only" => "Для цієї дії потрібен POST-запит.",
    "bulk_status_forbidden" => "Недостатньо прав для зміни статусу замовлень.",
    "bulk_status_session_expired" => "Сесія застаріла. Онови сторінку й повтори спробу.",
    "bulk_status_invalid" => "Вибери від 1 до :limit різних замовлень і допустимий статус.",
    "bulk_status_missing" => "Одне з вибраних замовлень уже недоступне. Нічого не змінено. Онови список.",
    "bulk_status_error" => "Не вдалося змінити статус. Зміни не збережено.",
    "bulk_status_request_error" => "Не вдалося підтвердити результат. Онови список перед повторною спробою.",
    "bulk_status_success" => "Змінено замовлень: :updated. Без змін: :unchanged.",
    "bulk_status_event_warning" => "Статуси збережено, але додатковий обробник завершився з помилкою. Перевір журнал.",
    ...
    "search_orders" => "Пошук за № замовлення, замовником, телефоном або email, датою чи сумою",
    ...
    "you_sure_duplicate" => "Ви впевнені, що хочете створити копію?",
    "general_settings" => "Загальні налаштування",
    "general_settings_intro" => "Ці налаштування визначають базову поведінку sCommerce, доступність основних модулів, перелік валют і формат відображення цін.",
    ...
    "previous_period" => "до попереднього періоду",
    "year" => "Рік",
    "pcs" => "шт.",
    "paid_share" => "Частка оплачених",
    "days" => "днів",
    ...
    "phone" => "Телефон",
    "email" => "Email",
    "this_action_affects_only_order" => "Ця дія змінює лише дані покупця, збережені в замовленні, і не зачіпає користувача в базі даних.",
    "recipient" => "Отримувач замовлення",
    "recipient_region" => "Область",
    "recipient_city" => "Місто",
    "recipient_street" => "Вулиця",
    "recipient_build" => "Будівля",
    "recipient_room" => "Квартира",
    "recipient_zip" => "Поштовий індекс",
    "recipient_person" => "Отримувач",
    "recipient_phone" => "Телефон",
    "city" => "Місто",
    "city_ref" => "ID міста",
    "warehouse" => "Склад/Відділення/Поштомат",
    "warehouse_ref" => "ID відділення/поштомату",
    "dashboard_catalog_total" => "Усього в каталозі",
    "dashboard_new_reviews" => "Нові",
    "dashboard_average_rating" => "Середня оцінка",
    "dashboard_top_products_by_views" => "Топ товари за переглядами",
    "dashboard_recent_reviews" => "Останні відгуки",
    "dashboard_to_reviews" => "До відгуків",
    ...
    "bulk_actions" => "Масові дії із замовленнями",
    "selected" => "Вибрано",
    "cancel_selection" => "Скасувати вибір",
    "change_status" => "Змінити статус",
    "additional_actions" => "Додаткові дії",
    "action_not_available" => "Ця дія поки недоступна",
    "select_all_orders" => "Вибрати всі замовлення на сторінці",
    "select_order" => "Вибрати замовлення :number",
    "photo" => "Фото",
    "pros" => "Переваги",
    "cons" => "Недоліки",
    "remove" => "Видалити",
    "are_you_sure_to_remove_photo" => "Ви впевнені? Це незворотна дія...",
];
