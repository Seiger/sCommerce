<?php return [
    ...
    "print_positions" => "Total line items: :count",
    "print_manager" => "Manager",
    "print_delivery_arrangement" => "By arrangement",
    "bulk_paid" => "Mark as paid",
    "bulk_print" => "Print orders",
    "bulk_delete" => "Delete selected",
    "bulk_paid_confirm" => "Confirm receipt of the outstanding payment for selected orders (:count)? Already paid orders will be skipped.",
    "bulk_delete_confirm" => "Soft delete :count selected orders? They can be restored.",
    "bulk_paid_ineligible" => "The selection contains an online payment, a disputed/refunded payment or an unknown balance. Check these orders individually. Nothing was changed.",
    "bulk_menu_forbidden" => "You cannot perform bulk order actions.",
    "bulk_menu_invalid" => "Select 1 to :limit distinct orders and a valid action.",
    "bulk_menu_missing" => "A selected order is no longer available. Reload the list. Nothing was changed.",
    "bulk_menu_error" => "The operation failed. No changes were saved.",
    "bulk_menu_success" => "Processed: :updated. Unchanged: :unchanged.",
    "bulk_menu_warning" => "Changes were saved, but an additional handler failed.",
    "bulk_menu_pending" => "Processing selected orders…",
    "bulk_print_blocked" => "Allow pop-up windows to open the print document.",
    "export_tracking" => "Tracking number",
    "bulk_export_pending" => "Preparing CSV…",
    "bulk_export_success" => "CSV download started.",
    "bulk_export_forbidden" => "You do not have permission to export orders.",
    "bulk_export_invalid" => "Select 1 to :limit distinct orders.",
    "bulk_export_missing" => "A selected order is no longer available. Reload the list before exporting.",
    "bulk_export_error" => "Could not download the CSV. Try again.",
    "add" => "Add",
    ...
    "use_api_calculation" => "Use API Calculation",
    "test_mode" => "Test Mode",
    ...
    "cache_description" => "Creating cache for fast product listing display",
    "canceled" => "Cancelled.",
    ...
    "account_holder_placeholder" => "Company Name or Individual",
    "bank_name" => "Bank Name",
    "bank_name_placeholder" => "Name of the bank",
    "account_number" => "Account Number (IBAN)",
    "bank_code" => "Bank Code (MFO/SWIFT)",
    "bank_code_placeholder" => "MFO or SWIFT code",
    "tax_id" => "Tax ID / EDRPOU",
    "tax_id_placeholder" => "Company tax identification number",
    "payment_terms_days" => "Payment Terms (days)",
    "auto_generate_invoice" => "Auto-generate invoice",
    "require_payment_confirmation" => "Require payment confirmation",
    "payment_instructions" => "Payment Instructions",
    "bank_invoice_info_placeholder" => "Additional payment instructions for customers, e.g., 'Please include order number in payment purpose'",
    ...
    "checkout_settings" => "Cart and orders",
    "checkout_settings_intro" => "These settings define product attribute display in the cart and sCommerce order number generation rules.",
    "orders_reference_prefix" => "Order number prefix",
    "orders_reference_prefix_help" => "Prefix added before the sequential order number (e.g. #, ORD_).",
    "orders_reference_start" => "Starting number",
    "orders_reference_start_help" => "Initial value of the counter for generating the order number.",
    "orders_reference_pad_left" => "Left zero padding",
    "orders_reference_pad_left_help" => "Minimum number length padded with leading zeros (0 = no padding).",
    ...
    "products_settings_intro" => "These settings define product-page functionality and the fields displayed in the sCommerce product list.",
    ...
    "notifications_email_intro" => "These settings define recipient addresses and sCommerce email notification templates for administrators and customers.",
    "notifications_email_administrator" => "Administrator",
    "notifications_email_customer" => "Customer",
    ...
    "notifications_email_addresses_default" => "Default notification addresses",
    "notifications_email_addresses_default_help" => "Base list of email addresses for sCommerce system notifications. It is used as a fallback when no site-specific addresses are configured.",
    "notifications_email_addresses_site_help" => "List of email addresses for this site's system notifications. If left empty, the default list will be used.",
    ...
    "bulk_status_confirm" => "Change the status of selected orders (:count) to “:status”?",
    "bulk_status_pending" => "Updating status…",
    "bulk_status_post_only" => "This action requires a POST request.",
    "bulk_status_forbidden" => "You do not have permission to change order statuses.",
    "bulk_status_session_expired" => "Your session has expired. Reload the page and try again.",
    "bulk_status_invalid" => "Select 1 to :limit distinct orders and a valid status.",
    "bulk_status_missing" => "A selected order is no longer available. Nothing was changed. Reload the list.",
    "bulk_status_error" => "Could not change the status. No changes were saved.",
    "bulk_status_request_error" => "Could not confirm the result. Reload the list before trying again.",
    "bulk_status_success" => "Orders updated: :updated. Unchanged: :unchanged.",
    "bulk_status_event_warning" => "Statuses were saved, but an additional handler failed. Check the log.",
    ...
    "search_orders" => "Search by order number, customer, phone or email, date, or amount",
    "search_help" => "Type of search for products.<br> <b>Blurred</b> - searches for individual words, with the result with the most matches at the beginning.<br> <b>Focused</b> - searches for occurrences of the search phrase.<br> <b>All words</b> - searches for products that contain all words from the query regardless of their order.",
    ...
    "general_settings_intro" => "These settings define core sCommerce behavior, module availability, supported currencies, and price display formatting.",
    "delivery_info_placeholder" => "Additional delivery information",
    "delivery_info_helptext" => "This message will be shown to the user when selecting delivery",
    "test_mode_helptext" => "Enable to use test API key",
    "api_key_placeholder" => "Enter API key",
    "api_key_helptext" => "Get API key from delivery service business cabinet",
    "sender_city_placeholder" => "Kyiv",
    "sender_city_helptext" => "Sender city",
    "sender_warehouse_placeholder" => "Sender warehouse",
    "sender_warehouse_helptext" => "Sender warehouse or address",
    "service_type_warehouse_warehouse" => "Warehouse-Warehouse",
    "service_type_warehouse_doors" => "Warehouse-Address",
    "service_type_doors_warehouse" => "Address-Warehouse",
    ...
    "average_check" => "Average order value",
    ...
    "recipient_build" => "Building",
    "recipient_room" => "Appartment",
    "recipient_zip" => "Zip",
    "recipient_person" => "Recipient",
    "recipient_phone" => "Phone",
    "city" => "City",
    "city_ref" => "City ID",
    "warehouse" => "Warehouse/Branch/Terminal",
    "warehouse_ref" => "Branch/terminal ID",
    "dashboard_catalog_total" => "Total in catalog",
    "dashboard_new_reviews" => "New",
    "dashboard_average_rating" => "Average rating",
    "dashboard_top_products_by_views" => "Top products by views",
    "dashboard_recent_reviews" => "Recent reviews",
    "dashboard_to_reviews" => "To reviews",
    ...
    "bulk_actions" => "Bulk order actions",
    "selected" => "Selected",
    "cancel_selection" => "Cancel selection",
    "change_status" => "Change status",
    "additional_actions" => "Additional actions",
    "action_not_available" => "This action is not available yet",
    "select_all_orders" => "Select all orders on this page",
    "select_order" => "Select order :number",
    "photo" => "Photo",
    "pros" => "Advantages",
    "cons" => "Disadvantages",
    "remove" => "Remove",
    "are_you_sure_to_remove_photo" => "Are you sure? This is an irreversible action...",
];
