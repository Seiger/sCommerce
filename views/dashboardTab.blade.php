    ...
    <div class="scom-dashboard__grid">
        ...
        <section class="scom-dashboard__card">
            ...
            @forelse($topProducts as $product)
                <li class="scom-dashboard__product"><div class="scom-dashboard__product-image"><img src="{{$product['cover']}}" alt=""></div><div><span class="scom-dashboard__product-name">{{$product['title']}}</span><span class="scom-dashboard__product-meta"><span>@svg('tabler-eye', 'scom-dashboard__product-meta-icon') {{$product['views']}}</span><span>@lang('sCommerce::global.orders'): {{$product['count']}}</span></span></div><span class="scom-dashboard__product-revenue">{{sCommerce::convertPrice($product['revenue'], sCommerce::currentCurrency())}}</span></li>
            @empty
