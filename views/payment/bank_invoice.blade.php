{{--
    ...
    - $info           : Additional payment instructions (optional, can be empty)

    You can customize this template to match your site's design.
    All variables are already escaped and safe to use.
--}}
<div class="bank-invoice-details">
    <h3>{{$title}}</h3>
    <div class="payment-info">
        <p class="payment-amount"><strong>{{sCommerce::convertPrice($cost)}}</strong></p>
        <div class="bank-details">
            ...
            <table class="bank-details-table">
                ...
                <tr>
                    ...
                    <td>{{sCommerce::convertPrice($cost)}}</td>
                </tr>
                <tr>
