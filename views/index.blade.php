...
@section('content')
    ...
    <h1><span data-tooltip="@lang('sCommerce::global.description')">@lang('sCommerce::global.icon', ['w' => '16px'])</span> @lang('sCommerce::global.title')</h1>
...
@push('scripts.bot')
    ...
    <div id="copyright"><a href="https://seiger.github.io/sCommerce/" target="_blank"><img src="{{asset('site/seigerit-blue.svg')}}" alt="Seiger IT Logo"/></a></div>
@endpush
