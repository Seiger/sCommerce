...
- **[Руководство разработчика](./developers/index.md)** - Расширенная конфигурация и настройка
- **[Административное руководство](./admin/index.md)** - Управление магазином через админ-панель
